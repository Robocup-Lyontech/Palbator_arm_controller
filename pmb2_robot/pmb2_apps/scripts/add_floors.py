...
def main():
    ...
    pose.pose.orientation.w = 1.0
    scene.add_box("wrc_tall_table", pose, size=(0.45, 0.45, 0.02))
    rospy.sleep(1.0)
    ...
    pose.pose.orientation.w = 1.0
    scene.add_box("wrc_long_table", pose, size=(1.25, 0.45, 0.02))
    rospy.sleep(1.0)
    ...
    pose.pose.position.z = 0.39
    pose.pose.orientation.w = 1.0
    scene.add_box("wrc_long_table_0", pose, size=(1.25, 0.45, 0.02))
    rospy.sleep(1.0)
    ...
    pose.pose.orientation.w = 1.0
    scene.add_box("slit1", pose, size=(0.85, 0.33, 0.02))
    rospy.sleep(1.0)
    ...
    pose.pose.orientation.w = 1.0
    scene.add_box("slit2", pose, size=(0.85, 0.33, 0.02))
    rospy.sleep(1.0)
